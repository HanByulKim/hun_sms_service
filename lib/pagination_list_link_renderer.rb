class PaginationListLinkRenderer < WillPaginate::ActionView::LinkRenderer
  ...
  def to_html
    ...
    links.unshift(page_link_or_span(@collection.previous_page, 'left', @options[:previous_label]))
    links.push(page_link_or_span(@collection.next_page, 'right', @options[:next_label]))
